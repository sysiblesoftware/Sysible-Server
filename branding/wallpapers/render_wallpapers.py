#!/usr/bin/env python3
"""Sysible Server wallpaper generator — the SINGLE reproducible source for every
shipped desktop background.

Renders each procedural style at 7680x4320 (JPEG q92) in DARK and LIGHT variants
with the LOCKED "SYSIBLE SERVER" banner composited bottom-left on every one.
...
# ============================================================================
# BANNER — LOCKED design (banner_c_mock.py). small SYSIBLE SERVER, green rule
