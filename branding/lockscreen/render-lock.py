...
+ "SYSIBLE SERVER" wordmark (Sora) with a green accent underline, set a touch
...
def render(W, H, out):
    ...
    # A small "SYSIBLE SERVER" wordmark anchored to the BOTTOM — no centred mark.
    ...
    wy = int(H * 0.80)
    tw = _wordmark(draw, "SYSIBLE SERVER", font, cx, wy, FG, int(H * 0.006))
